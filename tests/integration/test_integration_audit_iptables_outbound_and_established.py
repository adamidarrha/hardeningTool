...
def test_integration_audit_iptables_outbound_and_established_pass_ipv4(setup_to_pass_ipv4):
    state = Centos7Audit().audit_iptables_outbound_and_established_connections(ip_version='ipv4')
    assert state == 0
...
def test_integration_audit_iptables_outbound_and_established_pass_ipv6(setup_to_pass_ipv6):
    state = Centos7Audit().audit_iptables_outbound_and_established_connections(ip_version='ipv6')
    assert state == 0
