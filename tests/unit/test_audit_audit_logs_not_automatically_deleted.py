...
@patch.object(Centos7Audit, "_shellexec", mock_audit_logs_not_automatically_deleted_pass)
def test_audit_audit_logs_not_automatically_deleted_pass():
    state = test.audit_audit_logs_not_automatically_deleted()
    assert state == 0


@patch.object(Centos7Audit, "_shellexec", mock_audit_logs_not_automatically_deleted_fail)
