...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_for_changes_to_sysadmin_scope_are_collected_pass)
...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_for_changes_to_sysadmin_scope_are_collected_fail)
