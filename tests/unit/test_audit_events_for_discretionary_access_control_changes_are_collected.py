...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_for_discretionary_access_control_changes_are_collected_pass)
...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_for_discretionary_access_control_changes_are_collected_fail)
