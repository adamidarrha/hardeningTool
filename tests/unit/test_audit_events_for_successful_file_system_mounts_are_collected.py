...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_for_successful_file_system_mounts_are_collected_pass)
...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_for_successful_file_system_mounts_are_collected_fail)
