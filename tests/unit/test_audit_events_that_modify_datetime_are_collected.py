...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_that_modify_datetime_are_collected_pass)
def test_audit_events_that_modify_datetime_are_collected_pass():
    state = test.audit_events_that_modify_datetime_are_collected()
    assert state == 0


@patch.object(Centos7Audit, "_shellexec", mock_audit_events_that_modify_datetime_are_collected_fail)
