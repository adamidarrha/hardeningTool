...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_that_modify_usergroup_info_are_collected_pass)
...
@patch.object(Centos7Audit, "_shellexec", mock_audit_events_that_modify_usergroup_info_are_collected_fail)
