...
@patch.object(Centos7Audit, "_shellexec", mock_audit_journald_configured_to_send_logs_to_rsyslog_pass)
...
@patch.object(Centos7Audit, "_shellexec", mock_audit_journald_configured_to_send_logs_to_rsyslog_fail)
