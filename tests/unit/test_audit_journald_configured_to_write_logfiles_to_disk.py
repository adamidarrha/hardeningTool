...
@patch.object(Centos7Audit, "_shellexec", mock_audit_journald_configured_to_write_logfiles_to_disk_pass)
...
@patch.object(Centos7Audit, "_shellexec", mock_audit_journald_configured_to_write_logfiles_to_disk_fail)
